...
open external class Object3D(){
	...
	*/
	open fun attach(`object`: ch.viseon.threejs.declarations.core.Object3D = definedExternally) : Object3D
	...
	*/
	...
	/**
	* meta -- object containing metadata such as materials, textures or images for the object. Convert the object to three.js [link:https://github.com/mrdoob/three.js/wiki/JSON-Object-Scene-format-4 JSON Object/Scene format].
	*/
