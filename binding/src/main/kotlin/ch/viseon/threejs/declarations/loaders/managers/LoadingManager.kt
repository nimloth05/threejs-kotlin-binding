...
package ch.viseon.threejs.declarations.loaders.managers
	...
	*/
open external class LoadingManager(onLoad: dynamic/*Function*/ = definedExternally, onProgress: dynamic/*Function*/ = definedExternally, onError: dynamic/*Function*/ = definedExternally){
	...
	*/
	open var onProgress: dynamic/*Function*/  = definedExternally
	...
	*/
	open var onError: dynamic/*Function*/  = definedExternally
	...
	*/
	open fun setURLModifier(callback: dynamic/*Function*/ = definedExternally) : dynamic/*null*/
...
Note: The following methods are designed to be called internally by loaders. You shouldn't call them directly.
	...
	*/
	open fun itemStart(url: String = definedExternally) : dynamic/*null*/
	...
	*/
	open fun itemEnd(url: String = definedExternally) : dynamic/*null*/
	...
	*/
	open fun itemError(url: String = definedExternally) : dynamic/*null*/
}