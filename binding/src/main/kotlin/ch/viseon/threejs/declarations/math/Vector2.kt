...
package ch.viseon.threejs.declarations.math
	...
	*/
open external class Vector2(x: Float = definedExternally, y: Float = definedExternally){
	...
	*/
	open fun addScalar(s: Float = definedExternally) : Vector2


	/**
	* Adds the multiple of [page:Vector2 v] and [page:Float s] to this vector.
	*/
	open fun addScaledVector(v: ch.viseon.threejs.declarations.math.Vector2 = definedExternally, s: Float = definedExternally) : Vector2
	...
	*/
	open fun clampLength(min: Float = definedExternally, max: Float = definedExternally) : Vector2
	...
	*/
	open fun clampScalar(min: Float = definedExternally, max: Float = definedExternally) : Vector2
	...
	*/
	open fun distanceTo(v: ch.viseon.threejs.declarations.math.Vector2 = definedExternally) : Float


	/**
	* Computes the [link:https://en.wikipedia.org/wiki/Taxicab_geometry Manhattan distance] from this vector to [page:Vector2 v].
	*/
	open fun manhattanDistanceTo(v: ch.viseon.threejs.declarations.math.Vector2 = definedExternally) : Float
	...
	*/
	open fun distanceToSquared(v: ch.viseon.threejs.declarations.math.Vector2 = definedExternally) : Float
	...
	*/
	open fun divideScalar(s: Float = definedExternally) : Vector2


	/**
	* Calculates the [link:https://en.wikipedia.org/wiki/Dot_product dot product] of this vector and [page:Vector2 v].
	*/
	open fun dot(v: ch.viseon.threejs.declarations.math.Vector2 = definedExternally) : Float
	...
	*/
	open fun cross(v: ch.viseon.threejs.declarations.math.Vector2 = definedExternally) : Float
	...
	*/
	open fun lerp(v: ch.viseon.threejs.declarations.math.Vector2 = definedExternally, alpha: Float = definedExternally) : Vector2
	...
	*/
	open fun lerpVectors(v1: ch.viseon.threejs.declarations.math.Vector2 = definedExternally, v2: ch.viseon.threejs.declarations.math.Vector2 = definedExternally, alpha: Float = definedExternally) : Vector2
	...
	*/
	open fun multiplyScalar(s: Float = definedExternally) : Vector2
	...
	*/
	open fun rotateAround(center: ch.viseon.threejs.declarations.math.Vector2 = definedExternally, angle: Float = definedExternally) : Vector2
	...
	*/
	open fun set(x: Float = definedExternally, y: Float = definedExternally) : Vector2
	...
	*/
	open fun setLength(l: Float = definedExternally) : Vector2


	/**
	* Sets the [page:.x x] and [page:.y y] values of this vector both equal to [page:Float scalar].
	*/
	open fun setScalar(scalar: Float = definedExternally) : Vector2


	/**
	* Replaces this vector's [page:.x x] value with [page:Float x].
	*/
	open fun setX(x: Float = definedExternally) : Vector2


	/**
	* Replaces this vector's [page:.y y] value with [page:Float y].
	*/
	open fun setY(y: Float = definedExternally) : Vector2
	...
	*/
	open fun subScalar(s: Float = definedExternally) : Vector2
