...
package ch.viseon.threejs.declarations.geometries
	...
	*/
open external class ExtrudeBufferGeometry(shapes: Array<dynamic> = definedExternally, options: dynamic = definedExternally): ch.viseon.threejs.declarations.core.BufferGeometry{
