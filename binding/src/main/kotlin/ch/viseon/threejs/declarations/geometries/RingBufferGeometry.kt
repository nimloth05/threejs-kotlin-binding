...
package ch.viseon.threejs.declarations.geometries
	...
	*/
open external class RingBufferGeometry(innerRadius: Double = definedExternally, outerRadius: Double = definedExternally, thetaSegments: Int = definedExternally, phiSegments: Int = definedExternally, thetaStart: Double = definedExternally, thetaLength: Double = definedExternally): ch.viseon.threejs.declarations.core.BufferGeometry{
