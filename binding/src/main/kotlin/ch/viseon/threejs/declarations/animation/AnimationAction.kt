...
open external class AnimationAction(mixer: ch.viseon.threejs.declarations.animation.AnimationMixer = definedExternally, clip: ch.viseon.threejs.declarations.animation.AnimationClip = definedExternally, localRoot: ch.viseon.threejs.declarations.core.Object3D = definedExternally){
	...
	*/
	open var loop: Float  = definedExternally
	...
	*/
	open var repetitions: Float  = definedExternally
	...
	*/
	open var weight: Float  = definedExternally
	...
	*/
	open fun crossFadeFrom(fadeOutAction: ch.viseon.threejs.declarations.animation.AnimationAction = definedExternally, durationInSeconds: Float = definedExternally, warpBoolean: Boolean = definedExternally) : ch.viseon.threejs.declarations.animation.AnimationAction
	...
	*/
	open fun crossFadeTo(fadeInAction: ch.viseon.threejs.declarations.animation.AnimationAction = definedExternally, durationInSeconds: Float = definedExternally, warpBoolean: Boolean = definedExternally) : ch.viseon.threejs.declarations.animation.AnimationAction
	...
	*/
	open fun fadeIn(durationInSeconds: Float = definedExternally) : ch.viseon.threejs.declarations.animation.AnimationAction
	...
	*/
	open fun halt(durationInSeconds: Float = definedExternally) : ch.viseon.threejs.declarations.animation.AnimationAction
	...
	*/
	open fun setDuration(durationInSeconds: Float = definedExternally) : ch.viseon.threejs.declarations.animation.AnimationAction
	...
	*/
	open fun setEffectiveTimeScale(timeScale: Float = definedExternally) : ch.viseon.threejs.declarations.animation.AnimationAction
	...
	*/
	open fun setEffectiveWeight(weight: Float = definedExternally) : ch.viseon.threejs.declarations.animation.AnimationAction


	/**
	* Sets the [page:.loop loop mode] and the number of [page:.repetitions repetitions]. This method can be chained.
	*/
	open fun setLoop(loopMode: Float = definedExternally, repetitions: Float = definedExternally) : ch.viseon.threejs.declarations.animation.AnimationAction
	...
	*/
	open fun startAt(startTimeInSeconds: Float = definedExternally) : ch.viseon.threejs.declarations.animation.AnimationAction
	...
	*/
	open fun warp(startTimeScale: Float = definedExternally, endTimeScale: Float = definedExternally, durationInSeconds: Float = definedExternally) : ch.viseon.threejs.declarations.animation.AnimationAction
}