...
package ch.viseon.threejs.declarations.geometries
	...
	*/
open external class PolyhedronBufferGeometry(vertices: Array<dynamic> = definedExternally, indices: Array<dynamic> = definedExternally, radius: Double = definedExternally, detail: Int = definedExternally): ch.viseon.threejs.declarations.core.BufferGeometry{
