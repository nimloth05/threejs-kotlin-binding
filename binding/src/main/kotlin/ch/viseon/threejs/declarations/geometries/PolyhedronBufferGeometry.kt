...
package ch.viseon.threejs.declarations.geometries
	...
	*/
open external class PolyhedronBufferGeometry(vertices: Array<dynamic>/*Array*/ = definedExternally, indices: Array<dynamic>/*Array*/ = definedExternally, radius: Double = definedExternally, detail: Int = definedExternally): ch.viseon.threejs.declarations.core.BufferGeometry{
