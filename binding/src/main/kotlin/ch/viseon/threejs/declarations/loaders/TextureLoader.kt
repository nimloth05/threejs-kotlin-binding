...
open external class TextureLoader(manager: ch.viseon.threejs.declarations.loaders.managers.LoadingManager = definedExternally){
	...
	*/
	open fun load(url: String = definedExternally, onLoad: dynamic/*Function*/ = definedExternally, onProgress: dynamic/*Function*/ = definedExternally, onError: dynamic/*Function*/ = definedExternally) : ch.viseon.threejs.declarations.textures.Texture


	/**
	* Set the [page:.crossOrigin] attribute.
	*/
	open fun setCrossOrigin(value: String = definedExternally) : dynamic/*null*/
