...
package ch.viseon.threejs.declarations.textures
	...
	*/
open external class VideoTexture(video: dynamic/*Video*/ = definedExternally, mapping: Int = definedExternally, wrapS: Int = definedExternally, wrapT: Int = definedExternally, magFilter: Int = definedExternally, minFilter: Int = definedExternally, format: Int = definedExternally, type: Int = definedExternally, anisotropy: Float = definedExternally): ch.viseon.threejs.declarations.textures.Texture{
