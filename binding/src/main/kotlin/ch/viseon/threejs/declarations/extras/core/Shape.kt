...
package ch.viseon.threejs.declarations.extras.core
	...
	*/
open external class Shape(points: Array<dynamic> = definedExternally): ch.viseon.threejs.declarations.extras.core.Path{
	...
	*/
	open var holes: Array<dynamic>  = definedExternally
	...
	*/
	open fun extractPoints(divisions: Int = definedExternally) : Array<dynamic>


	/**
	* divisions -- The fineness of the result. Get an array of [page:Vector2 Vector2s] that represent the holes in the shape.
	*/
	open fun getPointsHoles(divisions: Int = definedExternally) : Array<dynamic>
}