...
package ch.viseon.threejs.declarations.lights
	...
	*/
open external class RectAreaLight(color: Int = definedExternally, intensity: Float = definedExternally, width: Float = definedExternally, height: Float = definedExternally): ch.viseon.threejs.declarations.lights.Light{
