...
open external class Path(points: Array<dynamic>/*Array*/ = definedExternally): ch.viseon.threejs.declarations.extras.core.CurvePath{
	...
	*/
	open fun absarc(x: Double = definedExternally, y: Double = definedExternally, radius: Double = definedExternally, startAngle: Double = definedExternally, endAngle: Double = definedExternally, clockwise: Double = definedExternally) : dynamic/*null*/
	...
	*/
	open fun absellipse(x: Double = definedExternally, y: Double = definedExternally, xRadius: Double = definedExternally, yRadius: Double = definedExternally, startAngle: Double = definedExternally, endAngle: Double = definedExternally, clockwise: Double = definedExternally, rotation: Double = definedExternally) : dynamic/*null*/
	...
	*/
	open fun arc(x: Double = definedExternally, y: Double = definedExternally, radius: Double = definedExternally, startAngle: Double = definedExternally, endAngle: Double = definedExternally, clockwise: Double = definedExternally) : dynamic/*null*/
	...
	*/
	open fun ellipse(x: Double = definedExternally, y: Double = definedExternally, xRadius: Double = definedExternally, yRadius: Double = definedExternally, startAngle: Double = definedExternally, endAngle: Double = definedExternally, clockwise: Double = definedExternally, rotation: Double = definedExternally) : dynamic/*null*/
