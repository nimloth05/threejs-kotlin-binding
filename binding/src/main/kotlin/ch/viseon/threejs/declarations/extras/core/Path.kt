...
open external class Path(points: Array<dynamic> = definedExternally): ch.viseon.threejs.declarations.extras.core.CurvePath{
	...
	*/
	open fun absarc(x: Double = definedExternally, y: Double = definedExternally, radius: Double = definedExternally, startAngle: Double = definedExternally, endAngle: Double = definedExternally, clockwise: Double = definedExternally) : dynamic
	...
	*/
	open fun absellipse(x: Double = definedExternally, y: Double = definedExternally, xRadius: Double = definedExternally, yRadius: Double = definedExternally, startAngle: Double = definedExternally, endAngle: Double = definedExternally, clockwise: Double = definedExternally, rotation: Double = definedExternally) : dynamic
	...
	*/
	open fun arc(x: Double = definedExternally, y: Double = definedExternally, radius: Double = definedExternally, startAngle: Double = definedExternally, endAngle: Double = definedExternally, clockwise: Double = definedExternally) : dynamic
	...
	*/
	open fun bezierCurveTo(cp1X: Double = definedExternally, cp1Y: Double = definedExternally, cp2X: Double = definedExternally, cp2Y: Double = definedExternally, x: Double = definedExternally, y: Double = definedExternally) : dynamic
	...
	*/
	open fun ellipse(x: Double = definedExternally, y: Double = definedExternally, xRadius: Double = definedExternally, yRadius: Double = definedExternally, startAngle: Double = definedExternally, endAngle: Double = definedExternally, clockwise: Double = definedExternally, rotation: Double = definedExternally) : dynamic


	/**
	* Connects a [page:LineCurve] from [page:.currentPoint] to x, y onto the path.
	*/
	open fun lineTo(x: Double = definedExternally, y: Double = definedExternally) : dynamic


	/**
	* Move the [page:.currentPoint] to x, y.
	*/
	open fun moveTo(x: Double = definedExternally, y: Double = definedExternally) : dynamic
	...
	*/
	open fun quadraticCurveTo(cpX: Double = definedExternally, cpY: Double = definedExternally, x: Double = definedExternally, y: Double = definedExternally) : dynamic
	...
	*/
	open fun setFromPoints(vector2s: Array<dynamic> = definedExternally) : dynamic


	/**
	* points - An array of [page:Vector2 Vector2s] Connects a new [page:SplineCurve] onto the path.
	*/
	open fun splineThru(points: Array<dynamic> = definedExternally) : dynamic
}