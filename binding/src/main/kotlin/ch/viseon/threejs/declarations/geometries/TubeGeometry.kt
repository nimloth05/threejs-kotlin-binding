...
package ch.viseon.threejs.declarations.geometries
	...
	*/
open external class TubeGeometry(path: ch.viseon.threejs.declarations.extras.core.Curve = definedExternally, tubularSegments: Int = definedExternally, radius: Float = definedExternally, radialSegments: Int = definedExternally, closed: Boolean = definedExternally): ch.viseon.threejs.declarations.core.Geometry{
